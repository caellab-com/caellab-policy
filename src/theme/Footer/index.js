...
copyright={
  <div className="footer__copyright" style={{lineHeight: '1.8'}}>
    ...
    >
      法律文本不应限制传播，因此你可以随意地存档该页面、永久地保留这些信息，还可以被任何人用于学习、研究、更改后使用。虚舟实验室参与「自由知识运动」，这是一项旨在促进人类知识自由获取、使用、修改和分享的全球性社会与文化运动；反对过度限制的版权法律，倡导开放获取与知识共享。
    </div>
  </div>
}
    />
